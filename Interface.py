...
def menu_parametres(largeurFenetre: int, hauteurFenetre: int, path: str) -> str :
    ...
    rectangle(largeurFenetre // 2 - 200, 250, largeurFenetre // 2 + 200, 300, "white", epaisseur=2, tag="bouton")
    texte(largeurFenetre // 2, 275, "Options des valeurs", "white", "center", taille=24, tag="options")
...
def menu_options(largeurFenetre: int, hauteurFenetre: int, path: str, lst_options: list) -> tuple :
    ...
    texte(largeurFenetre // 2, hauteurFenetre - 125, "Retour aux paramètres", "white", "center", taille=24, tag="Parametres")
        ...
        if 275 <= x_souris <= 325 :
            ...
            if 299 <= y_souris <= 350 :
                ...
                if tev == "ClicGauche" :
                    ...
                    entree = input(True)
                    if entree != "" and int(entree) > 0 and int(entree) < 100 :
...
def error_msg() -> None :
    '''Message d'erreur pour les valeurs entrées.'''
    texte(175, 110,"Veuillez entrer \nune valeur valide", "red", "center", taille=25, tag="error_value")
    rectangle(50,70,300,150,"gold", tag="error_value")
